...
import com.sportsoutclass.outclassdl.TeamSelection;

import android.test.ActivityInstrumentationTestCase2;


public class goingToScenario1 extends ActivityInstrumentationTestCase2<TeamSelection> {
  	private Solo solo;

  	public goingToScenario1() {
		super(TeamSelection.class);
  	}
	...
	public void testRun() {
		...
		solo.waitForActivity(com.sportsoutclass.outclassdl.TeamSelection.class, 2000);
